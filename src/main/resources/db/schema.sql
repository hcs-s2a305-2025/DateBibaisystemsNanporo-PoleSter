...
CREATE TABLE IF NOT EXISTS notice_t(
    ...
    mail VARCHAR(50) NOT NULL REFERENCES user_m(mail) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS order_t(
    ...
    mail VARCHAR(255) NOT NULL REFERENCES user_m(mail) ON DELETE CASCADE ON UPDATE CASCADE,
    register_time timestamp NOT NULL,
...
CREATE TABLE IF NOT EXISTS order_detail_t(
    order_id INT REFERENCES order_t(order_id) ON DELETE CASCADE,
    order_count INT NOT NULL,
    goods_id VARCHAR(10) NOT NULL REFERENCES goods_m(goods_id),
...
CREATE TABLE IF NOT EXISTS transaction_detail_t(
    transaction_id INT REFERENCES transaction_t(transaction_id) ON DELETE CASCADE,
